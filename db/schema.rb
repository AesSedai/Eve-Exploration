...
ActiveRecord::Schema.define(version: 20141217183654) do
  ...
  create_table "map_jump_cache", primary_key: "history_id", force: true do |t|
    t.integer  "solar_system_id"
  ...
  create_table "map_jump_history", primary_key: "history_id", force: true do |t|
    t.integer  "solar_system_id"
    t.integer  "ship_jumps"
    t.datetime "cached_until"
    t.datetime "updated_at"
  ...
  create_table "schema_migration", id: false, force: true do |t|
